...
export default function Login() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Här skulle autentiseringslogiken implementeras
      ...
      <div className={styles.loginWrapper}>
        <div className={styles.loginCard}>
          <div className={styles.cardHeader}>
            <span className={styles.cardTag}>Välkommen tillbaka</span>
            <h1>
              Logga <span className={styles.gradientText}>in</span>
            </h1>
            <p>Logga in på ditt konto för att fortsätta din kreativa resa</p>
          </div>
          ...
          <div className={styles.registerLink}>
            Har du inget konto? <Link href="/register">Registrera dig</Link>
          </div>
        </div>

        <div className={styles.loginVisual}>
          <div className={styles.visualContent}>
            <h2>Upptäck kreativa möjligheter</h2>
            <p>
              Anslut med varumärken, hitta uppdrag och utveckla din kreativa karriär med Blimpify.
            </p>
            <div className={styles.features}>
              <div className={styles.feature}>
                ...
                <span>Hitta kreativa uppdrag</span>
              </div>
              <div className={styles.feature}>
                <svg
                  width="24"
                ...
                <span>Anslut med varumärken</span>
              </div>
              <div className={styles.feature}>
                <svg
                  width="24"
                ...
                <span>Väx din kreativa karriär</span>
              </div>
            </div>
          </div>
