  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <div className={styles.tableOfContents}>
          ...
          <ul>
            ...
            <li><a href="#information">2. Information vi samlar in</a></li>
            <li><a href="#usage">3. Hur vi använder din information</a></li>
            <li><a href="#sharing">4. Delning av information</a></li>
            <li><a href="#rights">5. Dina rättigheter</a></li>
            <li><a href="#cookies">6. Cookies och spårningstekniker</a></li>
            <li><a href="#security">7. Säkerhet</a></li>
            <li><a href="#children">8. Barn och integritet</a></li>
            <li><a href="#changes">9. Uppdateringar av policyn</a></li>
        ...
        <div className={styles.sectionsContainer}>
          ...
          <section id="information" className={styles.section}>
            ...
            <ul>
              ...
              <li>Betalningsinformation när du genomför transaktioner (notera att vi inte lagrar fullständiga kreditkortsuppgifter)</li>
          ...
          <section id="sharing" className={styles.section}>
            ...
            <ul>
              ...
              <li>Med affärspartners som erbjuder tjänster tillsammans med oss (endast med ditt samtycke)</li>
          ...
          <section id="rights" className={styles.section}>
            ...
            <p>
              Som användare har du flera rättigheter gällande dina personuppgifter:
            </p>
            <ul>
              ...
              <li>Rätt till radering - Du kan begära att vi raderar dina uppgifter under vissa omständigheter</li>
              <li>Rätt att invända - Du kan invända mot behandling av dina uppgifter</li>
              <li>Rätt till begränsning - Du kan begära att vi begränsar behandlingen av dina uppgifter</li>
              <li>Rätt till dataportabilitet - Du kan begära att få dina uppgifter överförda till en annan tjänst</li>
            </ul>
            <p>
              För att utöva dessa rättigheter, vänligen kontakta oss via uppgifterna i slutet av denna policy.
            </p>
          </section>
          ...
          <section id="cookies" className={styles.section}>
            ...
            <p>
              Vi använder både nödvändiga cookies som krävs för webbplatsens funktion och valfria cookies
              för analys och marknadsföring. Du kan hantera dina cookie-inställningar genom att besöka vår
          ...
          <section id="security" className={styles.section}>
            <h2>7. Säkerhet</h2>
            <p>
              Vi tar säkerheten för dina personuppgifter på allvar och implementerar lämpliga tekniska och
              organisatoriska åtgärder för att skydda dina uppgifter mot obehörig åtkomst, förlust eller skada.
            </p>
            <p>
              Dessa åtgärder inkluderar kryptering, säkra servrar, regelbundna säkerhetsgranskningar och
              strikt kontroll av åtkomst till personuppgifter.
            </p>
          </section>
          ...
          <section id="children" className={styles.section}>
            ...
            <p>
              Våra tjänster är inte avsedda för barn under 16 år, och vi samlar inte medvetet in personuppgifter
              från barn under denna ålder. Om du tror att vi har samlat in information från ett barn under 16 år,
              vänligen kontakta oss så att vi kan vidta lämpliga åtgärder.
            </p>
          </section>
          ...
          <section id="changes" className={styles.section}>
            ...
            <p>
              Vi kan uppdatera denna policy från tid till annan för att återspegla ändringar i vår verksamhet
              eller juridiska krav. Vi kommer att meddela dig om väsentliga ändringar genom att publicera den
              nya policyn på vår webbplats och, om det är lämpligt, via e-post.
            </p>
            <p>
              Vi uppmuntrar dig att regelbundet granska denna policy för att hålla dig informerad om hur vi
          ...
          <section id="contact" className={styles.section}>
            ...
            <p>
              E-post: <a href="mailto:privacy@blimpify.se">privacy@blimpify.se</a><br />
      ...
      <section className={styles.contactSection}>
        ...
        <p>Vi värnar om din integritet och är alltid redo att hjälpa dig med frågor om hur dina personuppgifter hanteras.</p>
